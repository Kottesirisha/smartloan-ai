...
export const getDatasetSamples = (params = {}) =>
  api.get("/dataset/samples", { params });
...
export const generateDummyDocs = (applicationId, mode = "clean", skipTax = false) =>
  api.post(`/applications/${applicationId}/generate-dummy-docs`, {
    mode,
    skip_tax: skipTax,
  });
...
export const submitOfficerReview = (applicationId, decision, notes, reviewedBy) =>
  api.post(`/applications/${applicationId}/officer-review`, {
    decision,
    notes,
...
export const getDocumentDownloadUrl = (documentId) =>
  `http://127.0.0.1:8001/documents/${documentId}/download`;

export const getDocumentsZipUrl = (applicationId) =>
  `http://127.0.0.1:8001/applications/${applicationId}/documents/zip`;
